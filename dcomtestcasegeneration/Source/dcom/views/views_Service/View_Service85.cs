    ...
    public partial class View_Service85 : UserControl
    {
        ...
        private void View_Service85_Load(object sender, EventArgs e)
        {
            ...
            for (int index = 0; index < ComboBox_ConditionNRCs.Length; index++)
            {
                ...
                ComboBox_ConditionNRCs[index].Enabled = UIVariables.Service85_ButtonStatus_Condition[index];
            }
            ...
            textBox_ConditionEngine_ValidValue.Text = UIVariables.Service85_ValidValueCondition;
            ...
            textBox_ConditionEngine_InvalidValue.Enabled = UIVariables.Service85_ButtonStatus_Condition[1];
            textBox_ConditionEngine_ValidValue.Enabled = UIVariables.Service85_ButtonStatus_Condition[1];
            textBox_ConditionVoltage_Low.Enabled = UIVariables.Service85_ButtonStatus_Condition[2];
            textBox_ConditionVoltage_High.Enabled = UIVariables.Service85_ButtonStatus_Condition[2];
        }
        ...
        {
            UIVariables.Service85_ButtonStatus_Condition[2] = !UIVariables.Service85_ButtonStatus_Condition[2];

            button_ConditionVoltage.BackColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service85_ButtonStatus_Condition[2])[0];
            button_ConditionVoltage.ForeColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service85_ButtonStatus_Condition[2])[1];
            button_ConditionVoltage.Text = Controller_UIHandling.GetNameOfStatusButton(UIVariables.Service85_ButtonStatus_Condition[2]);
        }
        ...
        private void button_PhysicalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_AddressingMode[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(1)[0][1]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
            {
        ...
        private void button_PhysicalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_AddressingMode[1] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(1)[0][2]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
        ...
        private void button_PhysicalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_AddressingMode[2] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(1)[0][3]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
        ...
        private void button_FunctionalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_AddressingMode[3] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(1)[1][1]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
        ...
        private void button_FunctionalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_AddressingMode[4] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(1)[1][2]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
        ...
        private void button_FunctionalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_AddressingMode[5] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(1)[1][3]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
        ...
        private void button_SupressBit_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service85_ButtonStatus_Optional[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService85?.ElementAt(4)[0][1]))
            {
                UIVariables.edited_View[11] = true;
            }
            else
        ...
        private void dataGridView_NRCPriority_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                if (dataGridView_NRCPriority.Rows[0].Cells[index].Value.ToString() != DatabaseVariables.DatabaseService85?.ElementAt(2)[index][1])
                {
                    UIVariables.edited_View[11] = true;
                }
                else
        ...
        {
            if (UIVariables.Service85_ButtonStatus_Condition[1] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionEngine.Text))
            {
                ...
                if (UIVariables.Service85_ButtonStatus_Condition[1] == true)
                {
                    ...
                    textBox_ConditionEngine_InvalidValue.Text = UIVariables.Service85_InvalidValueCondition[1];
        ...
        {
            if (UIVariables.Service85_ButtonStatus_Condition[0] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVehicleSpeed.Text))
            {
                ...
                if (UIVariables.Service85_ButtonStatus_Condition[0] == true)
                {
                    ...
                    textBox_ConditionVehicle.Text = UIVariables.Service85_InvalidValueCondition[0];
                }
                else
                {
        ...
        {
            if (UIVariables.Service85_ButtonStatus_Condition[2] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text))
            {
                UIVariables.Service85_ButtonStatus_Condition[2] = Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text);

                UIVariables.edited_View[11] = true;

                if (UIVariables.Service85_ButtonStatus_Condition[2] == true)
                {
                    ...
                    comboBox_ConditionVoltage_NRC.Text = UIVariables.Service85_NRCCondition[2];
                    textBox_ConditionVoltage_Low.Text = UIVariables.Service85_InvalidValueCondition[2];
                    textBox_ConditionVoltage_High.Text = UIVariables.Service85_InvalidValueCondition[3];
                }
                else
                {
        ...
        {
            if (UIVariables.Service85_NRCCondition[1] != comboBox_ConditionEngine_NRC.Text)
            {
                UIVariables.edited_View[11] = true;
        ...
        {
            if (UIVariables.Service85_NRCCondition[0] != comboBox_ConditionVehicle_NRC.Text)
            {
                UIVariables.edited_View[11] = true;
        ...
        {
            if (UIVariables.Service85_NRCCondition[2] != comboBox_ConditionVoltage_NRC.Text)
            {
                UIVariables.edited_View[11] = true;

                if (UIVariables.Service85_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service85_NRCCondition[2] = comboBox_ConditionVoltage_NRC.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service85_InvalidValueCondition[1] != textBox_ConditionEngine_InvalidValue.Text)
            {
                UIVariables.edited_View[11] = true;

                if (UIVariables.Service85_ButtonStatus_Condition[1] == true)
                {
                    UIVariables.Service85_InvalidValueCondition[1] = textBox_ConditionEngine_InvalidValue.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service85_ValidValueCondition != textBox_ConditionEngine_ValidValue.Text)
            {
                UIVariables.edited_View[11] = true;

                if (UIVariables.Service85_ButtonStatus_Condition[1] == true)
                {
                    UIVariables.Service85_ValidValueCondition = textBox_ConditionEngine_ValidValue.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service85_InvalidValueCondition[0] != textBox_ConditionVehicle.Text)
            {
                UIVariables.edited_View[11] = true;
        ...
        {
            if (UIVariables.Service85_InvalidValueCondition[2] != textBox_ConditionVoltage_Low.Text)
            {
                UIVariables.edited_View[11] = true;

                if (UIVariables.Service85_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service85_InvalidValueCondition[2] = textBox_ConditionVoltage_Low.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service85_InvalidValueCondition[3] != textBox_ConditionVoltage_High.Text)
            {
                UIVariables.edited_View[11] = true;

                if (UIVariables.Service85_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service85_InvalidValueCondition[3] = textBox_ConditionVoltage_High.Text;
                }
            }
            else
            {
