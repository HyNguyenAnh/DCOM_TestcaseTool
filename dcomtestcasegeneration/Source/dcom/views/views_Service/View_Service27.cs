...
namespace dcom.views.views_Service
{
    public partial class View_Service27 : UserControl
    {
        ...
        private void button_PhysicalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_AddressingMode[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(1)[0][1]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
            {
        ...
        private void button_PhysicalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_AddressingMode[1] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(1)[0][2]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
        ...
        private void button_PhysicalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_AddressingMode[2] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(1)[0][3]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
        ...
        private void button_FunctionalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_AddressingMode[3] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(1)[1][1]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
        ...
        private void button_FunctionalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_AddressingMode[4] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(1)[1][2]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
        ...
        private void button_FunctionalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_AddressingMode[5] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(1)[1][3]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
        ...
        private void dataGridView_NRCPrioritySeed_SelectionChanged(object sender, EventArgs e)
        {
            ...
            for (int index = 0; dataGridView_NRCPrioritySeed.Rows[0].Cells[index].Value.ToString() != ""; index++)
            {
                if (dataGridView_NRCPrioritySeed.Rows[0].Cells[index].Value.ToString() != DatabaseVariables.DatabaseService27?.ElementAt(2)[index][1])
                {
                    UIVariables.edited_View[7] = true;
                }
                else
        ...
        private void dataGridView_NRCPriorityKey_SelectionChanged(object sender, EventArgs e)
        {
            ...
            for (int index = 0; dataGridView_NRCPriorityKey.Rows[0].Cells[index].Value.ToString() != ""; index++)
            {
                if (dataGridView_NRCPriorityKey.Rows[0].Cells[index].Value.ToString() != DatabaseVariables.DatabaseService27?.ElementAt(2)[index][2])
                {
                    UIVariables.edited_View[7] = true;
                }
                else
        ...
        {
            if (UIVariables.Service27_ButtonStatus_Condition[1] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionEngine.Text))
            {
        ...
        {
            if (UIVariables.Service27_ButtonStatus_Condition[0] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVehicleSpeed.Text))
            {
        ...
        {
            if (UIVariables.Service27_ButtonStatus_Condition[2] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text))
            {
        ...
        {
            if (UIVariables.Service27_NRCCondition[1] != comboBox_ConditionEngine_NRC.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_NRCCondition[0] != comboBox_ConditionVehicle_NRC.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_NRCCondition[2] != comboBox_ConditionVoltage_NRC.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_InvalidValueCondition[1] != textBox_ConditionEngine_InvalidValue.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_ValidValueCondition != textBox_ConditionEngine_ValidValue.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_InvalidValueCondition[0] != textBox_ConditionVehicle.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_InvalidValueCondition[2] != textBox_ConditionVoltage_Low.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        {
            if (UIVariables.Service27_InvalidValueCondition[3] != textBox_ConditionVoltage_High.Text)
            {
                UIVariables.edited_View[7] = true;
        ...
        private void button_SupressBit_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service27_ButtonStatus_Optional[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService27?.ElementAt(4)[0][1]))
            {
                UIVariables.edited_View[7] = true;
            }
            else
