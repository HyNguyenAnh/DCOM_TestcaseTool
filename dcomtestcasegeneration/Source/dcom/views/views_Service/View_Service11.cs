    ...
    public partial class View_Service11 : UserControl
    {
        ...
        private void View_Service11_Load(object sender, EventArgs e)
        {
            ...
            for (int index = 0; index < ComboBox_ConditionNRCs.Length; index++)
            {
                ...
                ComboBox_ConditionNRCs[index].Enabled = UIVariables.Service11_ButtonStatus_Condition[index];
            }
            ...
            button_SupressBit.BackColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service11_ButtonStatus_Optional[0])[0];
            button_SupressBit.ForeColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service11_ButtonStatus_Optional[0])[1];
            button_SupressBit.Text = Controller_UIHandling.GetNameOfStatusButton(UIVariables.Service11_ButtonStatus_Optional[0]);
            ...
            textBox_ConditionEngine_ValidValue.Text = UIVariables.Service11_ValidValueCondition;
            ...
            // Set initial
            textBox_ConditionVehicle.Enabled = UIVariables.Service11_ButtonStatus_Condition[0];
            textBox_ConditionEngine_InvalidValue.Enabled = UIVariables.Service11_ButtonStatus_Condition[1];
            textBox_ConditionEngine_ValidValue.Enabled = UIVariables.Service11_ButtonStatus_Condition[1];
            textBox_ConditionVoltage_Low.Enabled = UIVariables.Service11_ButtonStatus_Condition[2];
            textBox_ConditionVoltage_High.Enabled = UIVariables.Service11_ButtonStatus_Condition[2];
        }
        ...
        private void button_KeyOnOffReset_Click(object sender, EventArgs e)
        {
        ...
        private void button_SoftReset_Click(object sender, EventArgs e)
        {
        ...
        {
            UIVariables.Service11_ButtonStatus_Optional[0] = !UIVariables.Service11_ButtonStatus_Optional[0];
        ...
        {
            UIVariables.Service11_ButtonStatus_Condition[2] = !UIVariables.Service11_ButtonStatus_Condition[2];

            button_ConditionVoltage.BackColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service11_ButtonStatus_Condition[2])[0];
            button_ConditionVoltage.ForeColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service11_ButtonStatus_Condition[2])[1];
            button_ConditionVoltage.Text = Controller_UIHandling.GetNameOfStatusButton(UIVariables.Service11_ButtonStatus_Condition[2]);
        }
        ...
        private void button_PhysicalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_AddressingMode[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(1)[0][1]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
            {
        ...
        private void button_PhysicalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_AddressingMode[1] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(1)[0][2]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_PhysicalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_AddressingMode[2] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(1)[0][3]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_FunctionalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_AddressingMode[3] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(1)[1][1]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_FunctionalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_AddressingMode[4] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(1)[1][2]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_FunctionalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_AddressingMode[5] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(1)[1][3]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_HardReset_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_ResetMode[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(0)[0][1]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_KeyOnOffReset_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_ResetMode[1] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(0)[1][1]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void button_SoftReset_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service11_ButtonStatus_ResetMode[2] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(0)[2][1]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        {
            UIVariables.Service11_ButtonStatus_Optional[0] = Controller_ServiceHandling.ConvertFromStatusToBool(button_SupressBit.Text);
            if (UIVariables.Service11_ButtonStatus_Optional[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService11?.ElementAt(4)[0][1]))
            {
                UIVariables.edited_View[2] = true;
            }
            else
        ...
        private void dataGridView_NRCPriority_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                if (dataGridView_NRCPriority.Rows[0].Cells[index].Value.ToString() != DatabaseVariables.DatabaseService11?.ElementAt(2)[index][1])
                {
                    UIVariables.edited_View[2] = true;
                }
                else
        ...
        {
            if (UIVariables.Service11_ButtonStatus_Condition[0] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVehicleSpeed.Text))
            {
                ...
                if (UIVariables.Service11_ButtonStatus_Condition[0] == true)
                {
                    ...
                    comboBox_ConditionVehicle_NRC.Text = UIVariables.Service11_NRCCondition[0];
                    textBox_ConditionVehicle.Text = UIVariables.Service11_InvalidValueCondition[0];
                }
                else
                {
        ...
        {
            if (UIVariables.Service11_ButtonStatus_Condition[1] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionEngine.Text))
            {
                ...
                if (UIVariables.Service11_ButtonStatus_Condition[1] == true)
                {
                    ...
                    comboBox_ConditionEngine_NRC.Text = UIVariables.Service11_NRCCondition[1];
                    textBox_ConditionEngine_InvalidValue.Enabled = true;
                    textBox_ConditionEngine_InvalidValue.Text = UIVariables.Service11_InvalidValueCondition[1];
        ...
        {
            if (UIVariables.Service11_ButtonStatus_Condition[2] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text))
            {
                UIVariables.Service11_ButtonStatus_Condition[2] = Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text);

                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[2] == true)
                {
                    ...
                    comboBox_ConditionVoltage_NRC.Text = UIVariables.Service11_NRCCondition[2];
                    textBox_ConditionVoltage_Low.Text = UIVariables.Service11_InvalidValueCondition[2];
                    textBox_ConditionVoltage_High.Text = UIVariables.Service11_InvalidValueCondition[3];
                }
                else
                {
        ...
        {
            if (UIVariables.Service11_NRCCondition[1] != comboBox_ConditionEngine_NRC.Text)
            {
                UIVariables.edited_View[2] = true;
        ...
        {
            if (UIVariables.Service11_NRCCondition[0] != comboBox_ConditionVehicle_NRC.Text)
            {
                UIVariables.edited_View[2] = true;
        ...
        {
            if (UIVariables.Service11_NRCCondition[2] != comboBox_ConditionVoltage_NRC.Text)
            {
                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service11_NRCCondition[2] = comboBox_ConditionVoltage_NRC.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service11_InvalidValueCondition[0] != textBox_ConditionVehicle.Text)
            {
                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[0] == true)
                {
                    UIVariables.Service11_InvalidValueCondition[0] = textBox_ConditionVehicle.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service11_InvalidValueCondition[1] != textBox_ConditionEngine_InvalidValue.Text)
            {
                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[1] == true)
                {
                    UIVariables.Service11_InvalidValueCondition[1] = textBox_ConditionEngine_InvalidValue.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service11_ValidValueCondition != textBox_ConditionEngine_ValidValue.Text)
            {
                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[1] == true)
                {
                    UIVariables.Service11_ValidValueCondition = textBox_ConditionEngine_ValidValue.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service11_InvalidValueCondition[2] != textBox_ConditionVoltage_Low.Text)
            {
                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service11_InvalidValueCondition[2] = textBox_ConditionVoltage_Low.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service11_InvalidValueCondition[3] != textBox_ConditionVoltage_High.Text)
            {
                UIVariables.edited_View[2] = true;

                if (UIVariables.Service11_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service11_InvalidValueCondition[3] = textBox_ConditionVoltage_High.Text;
                }
            }
            else
            {
