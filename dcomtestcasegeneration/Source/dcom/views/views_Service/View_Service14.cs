    ...
    public partial class View_Service14 : UserControl
    {
        ...
        private void View_Service14_Load(object sender, EventArgs e)
        {
            ...
            for (int index = 0; index < ComboBox_ConditionNRCs.Length; index++)
            {
                ...
                ComboBox_ConditionNRCs[index].Enabled = UIVariables.Service14_ButtonStatus_Condition[index];
            }
            ...
            {
                InvalidValue_Condition[index].Text = UIVariables.Service14_InvalidValueCondition[index];
            }
            textBox_ConditionEngine_ValidValue.Text = UIVariables.Service14_ValidValueCondition;
            ...
            textBox_ConditionEngine_InvalidValue.Enabled = UIVariables.Service14_ButtonStatus_Condition[1];
            textBox_ConditionEngine_ValidValue.Enabled = UIVariables.Service14_ButtonStatus_Condition[1];
            textBox_ConditionVoltage_Low.Enabled = UIVariables.Service14_ButtonStatus_Condition[2];
            textBox_ConditionVoltage_High.Enabled = UIVariables.Service14_ButtonStatus_Condition[2];
        }
        ...
        {
            UIVariables.Service14_ButtonStatus_Condition[2] = !UIVariables.Service14_ButtonStatus_Condition[2];

            button_ConditionVoltage.BackColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service14_ButtonStatus_Condition[2])[0];
            button_ConditionVoltage.ForeColor = Controller_UIHandling.GetColorOfStatusButton(UIVariables.Service14_ButtonStatus_Condition[2])[1];
            button_ConditionVoltage.Text = Controller_UIHandling.GetNameOfStatusButton(UIVariables.Service14_ButtonStatus_Condition[2]);
        }
        ...
        private void button_PhysicalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service14_ButtonStatus_AddressingMode[0] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService14?.ElementAt(1)[0][1]))
            {
                UIVariables.edited_View[3] = true;
            }
            else
            {
        ...
        private void button_PhysicalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service14_ButtonStatus_AddressingMode[1] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService14?.ElementAt(1)[0][2]))
            {
                UIVariables.edited_View[3] = true;
            }
            else
        ...
        private void button_PhysicalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service14_ButtonStatus_AddressingMode[2] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService14?.ElementAt(1)[0][3]))
            {
                UIVariables.edited_View[3] = true;
            }
            else
        ...
        private void button_FunctionalDefault_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service14_ButtonStatus_AddressingMode[3] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService14?.ElementAt(1)[1][1]))
            {
                UIVariables.edited_View[3] = true;
            }
            else
        ...
        private void button_FunctionalProgramming_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service14_ButtonStatus_AddressingMode[4] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService14?.ElementAt(1)[1][2]))
            {
                UIVariables.edited_View[3] = true;
            }
            else
        ...
        private void button_FunctionalExtended_TextChanged(object sender, EventArgs e)
        {
            ...
            if (UIVariables.Service14_ButtonStatus_AddressingMode[5] != Controller_ServiceHandling.ConvertFromStringToBool(DatabaseVariables.DatabaseService14?.ElementAt(1)[1][3]))
            {
                UIVariables.edited_View[3] = true;
            }
            else
        ...
        private void dataGridView_NRCPriority_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                if (dataGridView_NRCPriority.Rows[0].Cells[index].Value.ToString() != DatabaseVariables.DatabaseService14?.ElementAt(2)[index][1])
                {
                    UIVariables.edited_View[3] = true;
                }
                else
        ...
        {
            if (UIVariables.Service14_ButtonStatus_Condition[1] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionEngine.Text))
            {
                ...
                if (UIVariables.Service14_ButtonStatus_Condition[1] == true)
                {
                    ...
                    comboBox_ConditionEngine_NRC.Text = UIVariables.Service14_NRCCondition[1];
                    textBox_ConditionEngine_InvalidValue.Enabled = true;
                    textBox_ConditionEngine_InvalidValue.Text = UIVariables.Service14_InvalidValueCondition[1];
        ...
        {
            if (UIVariables.Service14_ButtonStatus_Condition[0] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVehicleSpeed.Text))
            {
        ...
        {
            if (UIVariables.Service14_ButtonStatus_Condition[2] != Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text))
            {
                UIVariables.Service14_ButtonStatus_Condition[2] = Controller_ServiceHandling.ConvertFromStatusToBool(button_ConditionVoltage.Text);

                UIVariables.edited_View[3] = true;

                if (UIVariables.Service14_ButtonStatus_Condition[2] == true)
                {
                    ...
                    comboBox_ConditionVoltage_NRC.Text = UIVariables.Service14_NRCCondition[2];
                    textBox_ConditionVoltage_Low.Text = UIVariables.Service14_InvalidValueCondition[2];
                    textBox_ConditionVoltage_High.Text = UIVariables.Service14_InvalidValueCondition[3];
                }
                else
                {
        ...
        {
            if (UIVariables.Service14_NRCCondition[1] != comboBox_ConditionEngine_NRC.Text)
            {
                UIVariables.edited_View[3] = true;
        ...
        {
            if (UIVariables.Service14_NRCCondition[0] != comboBox_ConditionVehicle_NRC.Text)
            {
                UIVariables.edited_View[3] = true;
        ...
        {
            if (UIVariables.Service14_NRCCondition[2] != comboBox_ConditionVoltage_NRC.Text)
            {
                UIVariables.edited_View[3] = true;

                if (UIVariables.Service14_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service14_NRCCondition[2] = comboBox_ConditionVoltage_NRC.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service14_InvalidValueCondition[1] != textBox_ConditionEngine_InvalidValue.Text)
            {
                UIVariables.edited_View[3] = true;

                if (UIVariables.Service14_ButtonStatus_Condition[1] == true)
                {
                    UIVariables.Service14_InvalidValueCondition[1] = textBox_ConditionEngine_InvalidValue.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service14_ValidValueCondition != textBox_ConditionEngine_ValidValue.Text)
            {
                UIVariables.edited_View[3] = true;

                if (UIVariables.Service14_ButtonStatus_Condition[1] == true)
                {
                    UIVariables.Service14_ValidValueCondition = textBox_ConditionEngine_ValidValue.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service14_InvalidValueCondition[0] != textBox_ConditionVehicle.Text)
            {
                UIVariables.edited_View[3] = true;
        ...
        {
            if (UIVariables.Service14_InvalidValueCondition[2] != textBox_ConditionVoltage_Low.Text)
            {
                UIVariables.edited_View[3] = true;

                if (UIVariables.Service14_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service14_InvalidValueCondition[2] = textBox_ConditionVoltage_Low.Text;
                }
            }
            else
            {
        ...
        {
            if (UIVariables.Service14_InvalidValueCondition[3] != textBox_ConditionVoltage_High.Text)
            {
                UIVariables.edited_View[3] = true;

                if (UIVariables.Service14_ButtonStatus_Condition[2] == true)
                {
                    UIVariables.Service14_InvalidValueCondition[3] = textBox_ConditionVoltage_High.Text;
                }
            }
            else
            {
