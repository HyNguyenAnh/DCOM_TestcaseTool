    ...
    class Model_GetServiceDatabase
    {
        ...
        public static List<string[]> Precondition(string SID)
        {
            ...
            for (int rowIndex = startRowIndexDatabaseTable[7]; ws.Cells[rowIndex, startColumnIndexDatabaseTable[7]].Text != ""; rowIndex++)
            {
                dataRow = new string[]
                {
                    ws.Cells[rowIndex, startColumnIndexDatabaseTable[7]    ].Text,  // Condition
                    ws.Cells[rowIndex, startColumnIndexDatabaseTable[7] + 1].Text,  // Status
                    ws.Cells[rowIndex, startColumnIndexDatabaseTable[7] + 2].Text,  // NRC
                };
