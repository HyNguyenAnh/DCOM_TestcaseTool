                ...
                for (int index = 0; index < UIVariables.Service2E_ButtonStatus_Condition?.Length; index++)
                {
                    ...
                    if (index == 0)
                    {
                        if (status == "1")
                        {
                            ...
                            Ws.Cells[rowIndex[8] + index, columnIndex[8] + 1] = UIVariables.Service2E_InvalidValueCondition[index];
                            Ws.Cells[rowIndex[8] + index, columnIndex[8] + 3] = status;
                            Ws.Cells[rowIndex[8] + index, columnIndex[8] + 4] = UIVariables.Service2E_NRCCondition[index];
                        }
                        else
                        {
                            Ws.Cells[rowIndex[8] + index, columnIndex[8] + 0] = condition;
                        ...
                        if (status == "1")
                        {
                            for (int index_ = 0; index_ < engineStatusConditionSplit.Length; index_++)
                            {
                                ...
                                if (engineStatusConditionSplit[index_].Trim().Split('(')[0] != "0")
                                {
                                    ...
                                    Ws.Cells[rowIndex[8] + index + index_, columnIndex[8] + 4] = UIVariables.Service2E_NRCCondition[index];
                                }
                                else
                                {
                    ...
                    else
                    {
                        for (int index_ = 0; index_ < 2; index_++)
                        {
                            ...
                            if (status == "1")
                            {
                                ...
                                Ws.Cells[rowIndex[8] + index + index_ + engineStatusConditionSplit.Length - 1, columnIndex[8] + 1] = UIVariables.Service2E_InvalidValueCondition[index + index_];
                                ...
                                Ws.Cells[rowIndex[8] + index + index_ + engineStatusConditionSplit.Length - 1, columnIndex[8] + 4] = UIVariables.Service2E_NRCCondition[index];
                            }
                            else
                            {
                                Ws.Cells[rowIndex[8] + index + index_ + engineStatusConditionSplit.Length - 1, columnIndex[8] + 0] = condition;
