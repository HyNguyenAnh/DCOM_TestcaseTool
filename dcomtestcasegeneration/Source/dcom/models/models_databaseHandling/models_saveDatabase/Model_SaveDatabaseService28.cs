        ...
        public static void SaveDatabaseService28(Worksheet Ws)
        {
            ...
            for (int index = 0; index < UIVariables.Service28_ButtonStatus_Condition.Length; index++)
            {
                ...
                if (status == "1")
                {
                    ...
                    Ws.Cells[rowIndex[8] + index, columnIndex[8] + 2] = UIVariables.Service28_NameInvalidValueCondition[index];
            ...
            for (int index = 0; index < DatabaseVariables.DatabaseService28.ElementAt(4).Count; index++)
            {
                ...
                {
                    status = Controller_ServiceHandling.ConvertFromBoolToStringBit(UIVariables.Service28_ButtonStatus_SuppressBit);
