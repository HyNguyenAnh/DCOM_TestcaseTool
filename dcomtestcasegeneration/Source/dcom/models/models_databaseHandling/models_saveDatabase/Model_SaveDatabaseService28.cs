...
{
    class Model_SaveDatabaseService28
    {
        public static void SaveDatabaseService28(Worksheet Ws, bool edited)
        {
            if (edited)
            {
                ...
                for (int index = 0; index < UIVariables.Service28_ButtonStatus_Condition?.Length; index++)
                {
                    ...
                    if (index == 0 && status == "1")
                    {
                        ...
                        Ws.Cells[rowIndex[8] + index, columnIndex[8] + 1] = UIVariables.Service28_InvalidValueCondition[index];
                        Ws.Cells[rowIndex[8] + index, columnIndex[8] + 3] = status;
                        Ws.Cells[rowIndex[8] + index, columnIndex[8] + 4] = UIVariables.Service28_NRCCondition[index];
                    }
                    else if (index == 1 && status == "1")
                    {
                        for (int index_ = 0; index_ < engineStatusConditionSplit.Length; index_++)
                        {
                            ...
                            if (engineStatusConditionSplit[index_].Trim().Split('(')[0] != "0")
                            {
                                ...
                                Ws.Cells[rowIndex[8] + index + index_, columnIndex[8] + 4] = UIVariables.Service28_NRCCondition[index];
                            }
                            else
                            {
                    ...
                    else if (index == 2 && status == "1")
                    {
                        for (int index_ = 0; index_ < 2; index_++)
                        {
                            ...
                            Ws.Cells[rowIndex[8] + index + index_ + engineStatusConditionSplit.Length - 1, columnIndex[8] + 1] = UIVariables.Service28_InvalidValueCondition[index + index_];
                            ...
                            Ws.Cells[rowIndex[8] + index + index_ + engineStatusConditionSplit.Length - 1, columnIndex[8] + 4] = UIVariables.Service28_NRCCondition[index];
                        }
                    }
                    else
                    {
