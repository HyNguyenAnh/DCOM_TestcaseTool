                ...
                if (subFunctionIndex <= subFunction.Length - 1)
                {
                    for (int index = 0; index < 3; index++)
                    {
                        string step =
                            ...
                            (TestStepIndex + 3) + ") " + Model_TestcaseKeyword.RequestService27(subFunction[subFunctionIndex], isSubFunctionSupported: Controller_ServiceHandling.ConvertFromStringToBool(Specification.ElementAt(subFunctionIndex)[1]),
                            ...
                            (TestStepIndex + 8) + ") " + Model_TestcaseKeyword.RequestService27(subFunction[subFunctionIndex], isSubFunctionSupported: Controller_ServiceHandling.ConvertFromStringToBool(Specification.ElementAt(subFunctionIndex)[1]),
                            ...
                            (TestStepIndex + 13) + ") " + Model_TestcaseKeyword.RequestService27(subFunction[subFunctionIndex], isSubFunctionSupported: Controller_ServiceHandling.ConvertFromStringToBool(Specification.ElementAt(subFunctionIndex)[1]),
