...
namespace dcom.models.models_testcaseHandling
{
    class Model_PushTestcaseService19
    {
        ...
        public static List<string[]> Condition = DatabaseVariables.DatabaseService19.ElementAt(3);
        public static List<string[]> Optional = DatabaseVariables.DatabaseService19.ElementAt(4);
        ...
        public static void AllowSessionComponent(Worksheet ws, int startRowIndex)
        {
            ...
            ws.Cells[startRowIndex, TestcaseVariables.TestStepColumnIndex] = Model_GetTestRequestService19.GetTestRequestAllowSessionComponent()[0];
            ws.Cells[startRowIndex, TestcaseVariables.TestResponseColumnIndex] = Model_GetTestRequestService19.GetTestRequestAllowSessionComponent()[1];
            ws.Cells[startRowIndex, TestcaseVariables.TestStepKeywordColumnIndex] = Model_GetTestRequestService19.GetTestRequestAllowSessionComponent()[2];
        ...
        public static void AddressingModeComponent(Worksheet ws, int startRowIndex)
        {
            ...
            ws.Cells[startRowIndex, TestcaseVariables.TestStepColumnIndex] = Model_GetTestRequestService19.GetTestRequestAddressingModeComponent()[0];
            ws.Cells[startRowIndex, TestcaseVariables.TestResponseColumnIndex] = Model_GetTestRequestService19.GetTestRequestAddressingModeComponent()[1];
            ws.Cells[startRowIndex, TestcaseVariables.TestStepKeywordColumnIndex] = Model_GetTestRequestService19.GetTestRequestAddressingModeComponent()[2];
            ws.Cells[startRowIndex, TestcaseVariables.ObjectTypeColumnIndex] = TestcaseVariables.ObjectType[2];
            ws.Cells[startRowIndex, TestcaseVariables.TestStatusColumnIndex] = TestcaseVariables.TestStatus;
            ws.Cells[startRowIndex, TestcaseVariables.ProjectColumnIndex] = DatabaseVariables.ProjectName;
        ...
        public static void SuppressBitComponent(Worksheet ws, int startRowIndex)
        {
            ...
            ws.Cells[startRowIndex, TestcaseVariables.TestStepColumnIndex] = Model_GetTestRequestService19.GetTestRequestSuppressBitComponent()[0];
            ws.Cells[startRowIndex, TestcaseVariables.TestResponseColumnIndex] = Model_GetTestRequestService19.GetTestRequestSuppressBitComponent()[1];
            ws.Cells[startRowIndex, TestcaseVariables.TestStepKeywordColumnIndex] = Model_GetTestRequestService19.GetTestRequestSuppressBitComponent()[2];
            ws.Cells[startRowIndex, TestcaseVariables.ObjectTypeColumnIndex] = TestcaseVariables.ObjectType[2];
            ws.Cells[startRowIndex, TestcaseVariables.TestStatusColumnIndex] = TestcaseVariables.TestStatus;
            ws.Cells[startRowIndex, TestcaseVariables.ProjectColumnIndex] = DatabaseVariables.ProjectName;
    ...
    class Model_GetTestRequestService19
    {
        public static string SID = "19";
                ...
                if (subFunctionIndex <= subFunction.Length - 1)
                {
                    for (int index = 0; index < 3; index++)
                    {
                        string step =
                            ...
                            (TestStepIndex + 3) + ") " + Model_TestcaseKeyword.RequestService19(subFunction[subFunctionIndex], isSubFunctionSupported: Controller_ServiceHandling.ConvertFromStringToBool(Specification.ElementAt(subFunctionIndex)[1]),
                            ...
                            (TestStepIndex + 8) + ") " + Model_TestcaseKeyword.RequestService19(subFunction[subFunctionIndex], isSubFunctionSupported: Controller_ServiceHandling.ConvertFromStringToBool(Specification.ElementAt(subFunctionIndex)[1]),
                            ...
                            (TestStepIndex + 13) + ") " + Model_TestcaseKeyword.RequestService19(subFunction[subFunctionIndex], isSubFunctionSupported: Controller_ServiceHandling.ConvertFromStringToBool(Specification.ElementAt(subFunctionIndex)[1]),
